 ...
 * Promotional area highlighting the mobile application and first-purchase vouchers.
 * Features a device mockup with decorative background elements.
 */
export default function DownloadAppSection() {
  return (
    <section className="mx-auto w-full max-w-[1320px] px-4 pb-16 pt-12 sm:px-6 sm:pb-18 sm:pt-14 lg:px-10 lg:pb-20 lg:pt-14">
      {/* Responsive layout: Content stack on mobile, horizontal split on desktop */}
      <div className="grid grid-cols-1 items-center gap-x-5 gap-y-2 lg:grid-cols-2 lg:items-center lg:gap-x-4 lg:gap-y-0 xl:gap-x-6">
        ...
        {/* Value Proposition and CTA Store Badges */}
        ...
        {/* Device Mockup with decorative elements and entry animations */}
        <div className="motion-scale-in motion-delay-1 order-2 -mt-1 flex justify-center lg:order-2 lg:-mt-3 lg:justify-end">
          <div className="relative">
            {/* Small decorative colored circles matching design reference */}
            ...
            {/* Concentric background rings for visual depth */}
        ...
        {/* Mobile-only store badges row (stacked layout) */}
