...
export default function PartnerBrandsSlider() {
  return (
    ...
    <section className="mt-0 bg-[#e6c744] px-6 py-6 sm:px-10 sm:py-7 lg:py-8">
      ...
      <div className="mx-auto flex w-full max-w-[1320px] flex-col items-center gap-7 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-10 lg:flex-nowrap lg:justify-between lg:gap-6">
        {brands.map((brand) => (
          ...
          <div key={brand.alt} className="relative flex h-[42px] w-auto items-center justify-center lg:h-[48px]">
            <Image
              src={brand.src}
              alt={brand.alt}
              width={brand.width}
