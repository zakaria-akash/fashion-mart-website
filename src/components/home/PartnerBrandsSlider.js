...
// List of partner brand logos for the slider strip
const brands = [
  ...
  { src: "/images/Brands-Slider/shopify.png", alt: "Shopify", width: 177, height: 63 },
  { src: "/images/Brands-Slider/lacoste.png", alt: "Lacoste", width: 236, height: 71 },
  { src: "/images/Brands-Slider/levis.png", alt: "Levi's", width: 128, height: 71 },
  { src: "/images/Brands-Slider/amazon.png", alt: "Amazon", width: 167, height: 64 },
];

/**
 * PartnerBrandsSlider Component
 * Displays a horizontal strip of partner logos beneath the hero section.
 * Features a high-contrast yellow background matching the site's accent color.
 */
export default function PartnerBrandsSlider() {
  return (
    <section className="motion-fade-in mt-0 bg-[#e6c744] px-6 py-6 sm:px-10 sm:py-7 lg:py-8">
      {/* Container for logo layout: Stacks on mobile, row on large screens */}
